  ...
  return (
    <div className="post-card">
      <div className="flex-between ">
        <div className="flex items-center gap-3">
          <Link to={`/profile/${post.creator.$id}`}>
            <img src={post?.creator?.imageUrl || '/assets/icons/profile-placeholder.svg'} alt="Autor" className='rounded-full w-12 lg:h-12' />
          </Link>
      ...
      <Link to={`/posts/${post.$id}`}>
        ...
        <div className="small-meidum leg:base-meidum py-5">
